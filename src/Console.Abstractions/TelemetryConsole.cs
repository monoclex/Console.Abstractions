...
namespace Console.Abstractions
{
	...
	public class TelemetryConsole : Console
	{
		...
		public TelemetryConsole([NotNull] Console console)
		{
			...
			ForegroundTelemetry =
				new Telemetry<ConsoleColor>(() => _console.Foreground, value => _console.Foreground = value);

			BackgroundTelemetry =
				new Telemetry<ConsoleColor>(() => _console.Background, value => _console.Background = value);
		}
